    ...
    data () {
      return {
        ...
        tableColumns: [
          ...
          { title: '磁盘容量', key: 'space' },
          { title: '磁盘可用空间', key: 'available' }
        ],
        tableData: [
          { id: 0, ip: '10.0.0.1', disk: 'E', space: '100', available: '80' },
          { id: 1, ip: '10.0.0.1', disk: 'E', space: '100', available: '80' },
          { id: 2, ip: '10.0.0.1', disk: 'E', space: '100', available: '80' },
          { id: 3, ip: '10.0.0.1', disk: 'E', space: '100', available: '80' }
        ]
      }
    },
    created () {
