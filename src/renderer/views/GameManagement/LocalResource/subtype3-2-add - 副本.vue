    ...
    <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" style="width:800px;">
        <FormItem prop="file">
          <Row>
            ...
            <i-col span="8">
              <img :src="imgUrl" v-if="showIcon === true">
              <Upload action="v1/netbar/upload" 
              name="uploadname"
      ...
      handleSubmit (name) {
        this.$refs[name].validate((valid) => {
          if (valid) {
            ...
            netbarAdd(this.formValidate.startPath, this.formValidate.starterScheme, this.formValidate.run, this.formValidate.name, this.formValidate.gamePath, this.formValidate.imgUrl, this.isSync).then((res) => {
